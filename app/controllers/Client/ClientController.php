...
require_once ROOT . FOLDER_PATH .'/app/models/Client/ClientModel.php';
...
class ClientController extends Controller
{
  ...
  {
    $params = array('avatar' => $this->session->get('avatar'),'email' => $this->session->get('email'),'rol' => $this->session->get('rol'),'show_form' => true, 'message' => $message);
  ...
  public function clientsList($message = '', $message_type = 'success')
  {
    ...
    $params = array('avatar' => $this->session->get('avatar'),'email' => $this->session->get('email'),'rol' => $this->session->get('rol'),'show_clients_list' => true, 'message_type' => $message_type, 'message' => $message, 'clients' => $clients);
  ...
  public function clientList($id)
  {
    ...
    $params = array('avatar' => $this->session->get('avatar'),'email' => $this->session->get('email'),'rol' => $this->session->get('rol'), 'show_edit_form' => true, 'info_client' => $info_client);
    return $this->render(__CLASS__, $params);
  }
