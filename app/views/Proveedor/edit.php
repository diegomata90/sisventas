    ...
    <section class="content-header">
      <h1>
        Editar Proveedor
        <small>Edicion de la Proveedor</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?= FOLDER_PATH .'/proveedor' ?>"><i class="fa fa-ship"></i> Proveedor</a></li>
        <li class="active">Edicion Proveedor</li>
      </ol>
    </section>
    ...
    <div class="row">
    <?php !$info_item ? exit('Hubo un error al cargar la información del proveedor') : '' ?>  

      <div class="col-md-12">
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">Edit Proveedor</h3>
          ...
          <div class="box-body">
            ...
            <form method="POST" action="<?= FOLDER_PATH . '/proveedor/Actualizar' ?>" enctype="multipart/form-data" >
              ...
              <a class="btn btn-default" href="<?= FOLDER_PATH . '/proveedor' ?>" role="button">Cancel</a>
            </form>
