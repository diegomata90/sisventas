        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add Ingreso</h3>
            ...
            <form method="POST" action="<?= FOLDER_PATH . '/Ingreso/Agregar' ?>" enctype="multipart/form-data">
              ...
              <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                <div class="form-group">
                  ...
                  <select name="idproveedor" id="idproveedor" class="form-control selectpicker" data-live-search="true">
                    <?php 
                    while ($persona = $proveedor->fetch_assoc()){
                    ...
                    <div class="form-group">
                        ...
                        <select name="pidarticulo" class="form-control selectpicker" id='pidarticulo'data-live-search="true">
                          ...
                          while ($art = $articulo->fetch_assoc()){
                            echo "<option value={$art['idarticulo']}>{$art['articulo']}</option>";
                          }
                           ?>                         
                        </select>
                    </div>
