        ...
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <a class="btn btn-primary" href="<?= FOLDER_PATH . '/cliente/New' ?>">+ Nuevo</a>              
              <br><br>
              <table id="TablaJquery" class="table table-bordered table-hover">
                ...
                <tbody>
                  ...
                  while ($row = $listado->fetch_assoc())
                  {
                    ...
                    echo "<td>
                    <a href='" . FOLDER_PATH ."/cliente/Obtener/{$row['idpersona']}' class='btn btn-primary fa fa-pencil'></a>
                    <a onclick='javascript:return asegurar();' href='" . FOLDER_PATH ."/cliente/Eliminar/{$row['idpersona']}' class='btn btn-danger fa fa-trash' ></a>
                    </td>";
                    echo '</tr>';
                  }
                  ?>
