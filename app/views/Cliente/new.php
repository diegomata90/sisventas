        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add Cliente</h3>
            ...
            <form method="POST" action="<?= FOLDER_PATH . '/cliente/Agregar' ?>" enctype="multipart/form-data">
              ...
              <a class="btn btn-primary" href="<?= FOLDER_PATH . '/cliente' ?>" role="button">Cancel</a>
            </form>
